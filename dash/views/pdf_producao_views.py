...
def gera_pdf_producao(request):
    ...
    if request.method == 'GET':                                                                     # 1.5.1 - Se houver uma requisição do tipo POST na página...
        ...
        response['Content-Disposition'] = 'attachment; filename="Relatório de Produção.pdf"'
        ...
        p.setFontSize(16)
        p.drawCentredString(canto_direito/2, 720, 'RELATÓRIO DE PRODUÇÃO')
