...
def maquina(request, id_maquina):
    ...
    dados = {
        ...
        'producao_maquina3': lista_producao_maquina.count(3),                                       # 1.6.3.2 - Variável que conta quantas peças foram produzidas no período filtrado na máquina com o ID 3
        'producao_maquina4': lista_producao_maquina.count(4),                                       # 1.6.3.3 - Variável que conta quantas peças foram produzidas no período filtrado na máquina com o ID 4
        'producao_maquina5': lista_producao_maquina.count(5),                                       # 1.6.3.4 - Variável que conta quantas peças foram produzidas no período filtrado na máquina com o ID 5
        'producao_maquina6': lista_producao_maquina.count(6),                                       # 1.6.3.5 - Variável que conta quantas peças foram produzidas no período filtrado na máquina com o ID 6
        'producao_maquina7': lista_producao_maquina.count(7),                                       # 1.6.3.6 - Variável que conta quantas peças foram produzidas no período filtrado na máquina com o ID 7 
        # @MQMAQUINA2#
        ...
        'paradas_maquina3': lista_paradas_maquina.count(3),                                         # 1.6.4.2 - Variável que conta quantas paradas foram registradas no período filtrado na máquina com o ID 3
        'paradas_maquina4': lista_paradas_maquina.count(4),                                         # 1.6.4.3 - Variável que conta quantas paradas foram registradas no período filtrado na máquina com o ID 4
        'paradas_maquina5': lista_paradas_maquina.count(5),                                         # 1.6.4.4 - Variável que conta quantas paradas foram registradas no período filtrado na máquina com o ID 5
        'paradas_maquina6': lista_paradas_maquina.count(6),                                         # 1.6.4.5 - Variável que conta quantas paradas foram registradas no período filtrado na máquina com o ID 6
        'paradas_maquina7': lista_paradas_maquina.count(7),                                         # 1.6.4.6 - Variável que conta quantas paradas foram registradas no período filtrado na máquina com o ID 7   
        #@MQMAQUINA3#
