...
def adicionaParadasListas_(data_antiga, data_nova, lista_paradas_maquina1, id):
    ...
    lista_paradas_maquina1.clear()                                                                  # 1.2.8 - Limpando a lista de paradas da máquina 1.    
    for i in result:                                                                                # 1.2.14 - Loop que percorrerá todos os itens do resultado obtido na consulta realizada no banco de dados.
        if i[2] == id:                                                                               # 1.2.14.1 - Se o terceiro item da lista percorrida for igual a 1...
            lista_paradas_maquina1.append(i[3])                                                     # 1.2.14.1.1 - Adiciona o item encontrado na lista de paradas da máquina 1.
