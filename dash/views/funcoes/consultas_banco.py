...
def consultaProducao(data_inicial, data_final, maquina_id):
    lista_producao = []
    con = conecta_db()
    cursor = con.cursor()                                                                    # 1.1.5 - Cursor que receberá os comandos do banco de dados.
...
def adicionaParadasListas_(data_antiga, data_nova, lista_paradas_maquina, id):
    con = conecta_db()
    cursor = con.cursor()                                                                    # 1.2.5 - Cursor que receberá todos os comandos que serão executados no banco de dados.
